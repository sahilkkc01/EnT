...
const Client = sequelize.define('Client', {
  ...
  clientSource: {
    type: DataTypes.ENUM('website', 'referral', 'social-media', 'walk-in', 'exhibition', 'existing-client', 'other'),
    allowNull: true,
  },
  preferredContact: {
...
const ClientTeamAssignment = sequelize.define("ClientTeamAssignment", {
  app_id: {
    type: DataTypes.INTEGER,
    allowNull: false,
  },
...
const LeadTeamAssignment = sequelize.define("LeadTeamAssignment", {
  app_id: {
    type: DataTypes.INTEGER,
    allowNull: false,
  },
...
const LeadQuotation = sequelize.define("LeadQuotation", {
  app_id: {
    type: DataTypes.INTEGER,
    allowNull: false,
  },
